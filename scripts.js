function addManualRow() {
    const table = document.getElementById("manualAttendanceTable").querySelector("tbody");
...
function updateRealTimeData() {
    ...
    liveTimeElements.forEach(element => {
        if (element.textContent.includes('h') && element.textContent !== element.dataset.originalText) {
...
function approveAllTimesheets() {
    ...
    setTimeout(() => {
        showNotification(`All ${count} timesheets approved successfully`, 'success');
    }, count * 300 + 500);
}
...
function processPayroll() {
    ...
    setTimeout(() => {
        showNotification('Payroll processed successfully! ₱278,064 net distributed.', 'success');
    }, 2000);
}
...
console.log('👥 Research Team: Christel Arpon (Lead), Janico Castillo, Angelica Villarisco, Lealene Fajardo');
console.log('🎯 Objectives: RFID + Biometric Integration, Fraud Prevention, Philippine Labor Law Compliance');
console.log('⚡ Features: Employee Management, Attendance Tracking, Payroll Processing, Research Compliance');
